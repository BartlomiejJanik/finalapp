...
public class User {
    ...
    public User(Integer id, String firstName, String lastName, String eMail, String passwordHash, String city, String country, String zipCode, String street, String birthDate, String pesel, String phone, boolean preferEmails) {
        this.id = id;
    ...
    public static User applyDTO(UserRegistrationDTO dto){
        ...
        user.passwordHash = String.valueOf(dto.getPasswordHash().hashCode());
